...
<script type="text/javascript">
	function check_form(form1) {
		...
		if(form1['user.age_y'].value == "" || form1['user.age_m'].value == "" || form1['user.age_d'].value == ""){
			alert("年齢を入れてください");
...
<div class="center">
	...
	<s:form action="" name="inputform" method="post" theme="simple">

		<tr>
			<td><font color="#FF0000">*</font>Soul名：</td>
			<td><input type="text" name="user.soul_name" placeholder="--名前入力してください--" />
			</td>

		</tr>
		<tr>
			<td><font color="#FF0000">*</font>性別：</td>
			<td><input type="radio" name="user.soul_sex" value="M" checked="checked" />男
				<input type="radio" name="user.soul_sex" value="F" />女</td>
		...
		<tr>
			<td>趣味：</td>
			<td><input type="checkbox" name="user.hobby_1" value="音楽" />音楽 <input
				type="checkbox" name="user.hobby_2" value="絵画" />絵画 <input type="checkbox"
				name="user.hobby_3" value="読書" />読書 <br> <input type="checkbox"
				name="user.hobby_4" value="ジョギング">ジョギング <input type="checkbox"
				name="user.hobby_5" value="ゲーム">ゲーム <input type="checkbox"
				name="user.hobby_6" value="映画">映画</td>
